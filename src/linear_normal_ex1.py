...
if os.path.isfile(path + 'model_LS_dataset_Normal' + '_size_' + \
    ...
    f = open(path + 'model_LS_dataset_Normal' + '_size_' + \
    ...
    f = open(path + 'model_LS_dataset_Normal' + '_size_' + str(training_size) + '.pkl', 'wb')
    pickle.dump(model, f)
    f.close()
...
save_res = path + 'acc_LS_dataset_Normal' + '_size_' + str(training_size)
